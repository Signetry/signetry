...
- **Embed governance in my own tool / script / hook** → [signetry-core](https://github.com/Signetry/core) (`pip install "signetry-core @ git+https://github.com/Signetry/core@v0.8.0"` — source-available, not on PyPI)
